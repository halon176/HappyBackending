...
@router.get(
    "/",
    name="Lista dei propri commenti",
    response_model=Optional[List[CommentResponse]],
)
...
async def create_comment(
    ...
    new_comment = Comment(
        content=payload.content.model_dump(), user_id=user_id, event_id=payload.event_id
    )
